...
class Controller:
    ...
    def __init__(self):
        ...
        self.setp.pose.position.altitude = 500
    ...
    def globalCb(self, msg):
        ...
        #self.local_coord.altitude = msg.alt/1000
    ...
    def updateSetp(self):
        ...
        #print("The distance is {:.3f} m.".format(self.g['s12']))
        if ((self.g['s12'] <= self.uncertain_dist) and (self.rotation <= self.uncertain_rad) and (self.height <= self.uncertain_dist/2)):
            print("globaldiller")
            self.setp.pose.position.latitude = self.local_coord.latitude
            self.setp.pose.position.longitude = self.local_coord.longitude
